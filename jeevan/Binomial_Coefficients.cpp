...
void solve() {
    ...
    for(int i = 0;i < n;i++){
        ...
        // cout << a << endl;
        // cout << mod_pow(facs[a-b],MOD-2)<< endl;
        // cout << mod_pow(facs[b],MOD-2) << endl;
        // cout << endl;
        cout << mod_mul(mod_mul(facs[a] , mod_pow(facs[a-b],MOD-2)) , mod_pow(facs[b],MOD-2)) << endl;
    }
}
